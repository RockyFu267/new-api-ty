<h1 align="center">⚠️ 個人デモ専用・商用利用禁止 ⚠️</h1>

<p align="center"><strong>この Fork に今後加えるコード変更は、個人によるデモンストレーションのみを目的としています。元のオープンソースプロジェクトの内容および関連する表記はすべて保持します。</strong></p>
